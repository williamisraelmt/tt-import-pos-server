    ...
    <div class="modal-content">
        ...
        <div class="modal-body" v-if="user">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" v-model="user.fullName" name="name" id="name" placeholder="Nombre del usuario">
            </div>
            <div class="mb-3">
                <label class="form-label" for="name">Cédula o # de pasaporte (Este será el nombre de usuario)</label>
                <input type="text" class="form-control" v-model="user.identification" name="identification" id="identification" placeholder="xxx-xxxxxxx-x">
            </div>
            <div class="mb-3">
                <label class="form-label" for="email">Correo</label>
                <input type="email" class="form-control" v-model="user.email" id="email" name="email" placeholder="xxx@xxx.xxx">
            </div>
            <div class="mb-3">
                <label class="form-label" for="phone">Teléfono</label>
                <input type="phone" class="form-control" v-model="user.phone" id="phone" name="phone" placeholder="xxx-xxx-xxxx">
            </div>
            <div class="mb-3" v-if="!selectedUserId">
                <label class="form-label" for="password">Clave</label>
                <input type="password" class="form-control" v-model="user.password" id="password" name="password" placeholder="****">
            </div>
            <div class="mb-3">
